...
namespace eShopSolution.BackendApi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get([FromQuery]GetProductPublicPagingRequest request)
        {
        ...
        {
            var isSuccesful = await _manageProductService.UpdatePrice(id,newPrice);
            if (!isSuccesful)
                return Ok();
            return BadRequest();
        }

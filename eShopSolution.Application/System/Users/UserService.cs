...
namespace eShopSolution.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResult<PageResult<UserViewModels>>> GetUsersPaging(GetUserPagingRequest request)
        {
            ...
            var pagedResult = new PageResult<UserViewModels>()
            {
            ...
            return new ApiSuccessResult<PageResult<UserViewModels>>(pagedResult);
        }
        ...
        public async Task<ApiResult<bool>> RoleAssign(Guid id, RoleAssignRequest request)
        {
            ...
            {
                var a = await _userManager.IsInRoleAsync(user, roleName);
